        ...
        {loading ? (
          ...
          <table className="min-w-full border border-gray-500">
            <thead>
                ...
                <th rowSpan={2} className="border px-4 py-2">Name</th>
                <th rowSpan={2} className="border px-4 py-2">Email</th>
                <th rowSpan={2} className="border px-4 py-2">Role</th>
              {/* Add a new row for Permissions heading */}
                <th colSpan={6} className="border px-4 py-2 text-center font-bold">
                  Permissions
                </th>
              <tr>
